  ...
  if (currentState === 'paywall') {
    return (
      <div className="relative flex flex-col overflow-x-hidden overflow-y-visible w-full min-h-screen">
        ...
        <div className="relative z-10 flex flex-col px-6 md:px-8 lg:px-12 pt-20 pb-8 animate-fade-in overflow-x-hidden w-full max-w-[600px] md:max-w-none mx-auto md:mx-0" style={{ paddingBottom: 'max(8rem, calc(env(safe-area-inset-bottom, 0px) + 8rem))' }}>
